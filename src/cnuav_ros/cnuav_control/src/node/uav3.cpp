...
int main(int argc, char **argv) {
    ...
    const std::string controller_config = "/home/lty/work_7.22/catkin_ws/src/cnuav_ros/cnuav_control/params/mpc_controller3.yaml";
    cnuav::Controller *mpc_controller = new cnuav::MPCController(controller_config);

    const std::string autopilot_config = "/home/lty/work_7.22/catkin_ws/src/cnuav_ros/cnuav_control/params/autopilot3.yaml";
