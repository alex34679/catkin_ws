...
int main(int argc, char **argv) {
    ...
    const std::string controller_config = "/home/tianbot/multi_uav/src/cnuav_ros/cnuav_control/params/mpc_controller2.yaml";
    cnuav::Controller *mpc_controller = new cnuav::MPCController(controller_config);

    const std::string autopilot_config = "/home/tianbot/multi_uav/src/cnuav_ros/cnuav_control/params/autopilot2.yaml";
