...
void GenerateBowknotTrajectory(quadrotor_common::Trajectory &trajectory);

int main(int argc, char **argv) {
    ros::init(argc, argv, "bowknot_gen_node");
    ...
    GenerateBowknotTrajectory(trajectory);
...
void GenerateBowknotTrajectory(quadrotor_common::Trajectory &trajectory) {
    ...
    way_points.push_back(Eigen::Vector3d(1.0, 1.0, 0.75));
    way_points.push_back(Eigen::Vector3d(1.5, 0.0, 1.0));
    way_points.push_back(Eigen::Vector3d(2.0, -2.0, 1.5));
    way_points.push_back(Eigen::Vector3d(0.0, 0.0, 0.5));
    way_points.push_back(Eigen::Vector3d(-1.0, 1.0, 0.75));
    way_points.push_back(Eigen::Vector3d(-1.5, 0.0, 1.0));
    way_points.push_back(Eigen::Vector3d(-2.0, -2.0, 1.5));
