...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  *rr++ = w6;
  /* #103: @2 = (2.*@7) */
  for (i=0, rr=w2, cs=w7; i<4; ++i) *rr++ = (2.* *cs++ );
  /* #104: @13 = @2[0] */
  ...
  *rr++ = w13;
  ...
  /* #127: @2 = @7' */
  casadi_copy(w7, 4, w2);
  /* #128: @8 = [0.0282843, -0.0282843, -0.0282843, 0.0282843] */
